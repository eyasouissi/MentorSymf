 ...
 */
final class Version20250221120914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `group` (id INT AUTO_INCREMENT NOT NULL, nbr_members INT NOT NULL, description_group LONGTEXT DEFAULT NULL, nom_group VARCHAR(255) NOT NULL, members VARCHAR(255) NOT NULL, date_creation_group DATE DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, date_meet DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE project_group (project_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_7E954D5B166D1F9C (project_id), INDEX IDX_7E954D5BFE54D947 (group_id), PRIMARY KEY(project_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE project_group ADD CONSTRAINT FK_7E954D5B166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE project_group ADD CONSTRAINT FK_7E954D5BFE54D947 FOREIGN KEY (group_id) REFERENCES `group` (id) ON DELETE CASCADE');
    }

 ...
 */
final class Version20250215184644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE attachement attachement JSON DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE attachement attachement LONGTEXT DEFAULT NULL COLLATE `utf8mb4_bin`');
    }
}
